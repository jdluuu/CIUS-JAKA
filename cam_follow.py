...
if __name__ == "__main__":
    ...
    # 相机关节角度发布器 
    joint1pub = rospy.Publisher('/jakaUr/joint1_position_controller/command', Float64, queue_size=1000)
    joint2pub = rospy.Publisher('/jakaUr/joint2_position_controller/command', Float64, queue_size=1000)
    angle1=Float64()
    angle2=Float64()
